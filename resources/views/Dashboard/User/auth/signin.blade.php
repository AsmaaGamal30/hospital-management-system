                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            ...
                                            <div class="panel" id="user">
                                                <h2>{{trans('Dashboard/login_trans.dropdownListTitle_user')}}</h2>
                                            ...
                                            <div class="panel" id="admin">
                                                <h2>{{trans('Dashboard/login_trans.dropdownListTitle_admin')}}</h2>
                                                <form method="POST" action="{{ route('admin.login') }}">
                                                    ...
                                                    <div class="row row-xs">
                                                        <div class="col-sm-6">
                                                            <button class="btn btn-block"><i class="fab fa-facebook-f"></i>{{trans('Dashboard/login_trans.sign_inf')}}</button>
                                                        </div>
                                                        <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                                            <button class="btn btn-info btn-block"><i class="fab fa-twitter"></i>{{trans('Dashboard/login_trans.sign_int')}}</button>
                                                        </div>
                                                    </div>
                                                </form>
                                                <div class="main-signin-footer mt-5">
